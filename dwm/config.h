...
static const char *screenshotcmd[] = { "/bin/sh", "-c", "file=~/Pictures/screenshot_$(date +%Y-%m-%d_%H-%M-%S).png && maim -s \"$file\" && xclip -selection clipboard -t image/png -i \"$file\"", NULL };
...
static const Key keys[] = {
    ...
    { 0,                            XK_F12,    spawn,          {.v = volumeupcmd } },
    { 0,                            XK_F11,    spawn,          {.v = volumedowncmd } },
